...
questions_list.append(
    Question('Сколько цветов в радуге', 'Семь', 'Восемь', 'Пять', 'Шесть'))

app = QApplication([])
btn_OK = QPushButton('Ответить')
lb_Question = QLabel('Самый трудный вопрос в мире!')
...
layout_card.addWidget(lb_Result, alignment=(Qt.AlignLeft | Qt.AlignTop))
layout_card.addWidget(lb_Correct, alignment=Qt.AlignHCenter, stretch=2)
